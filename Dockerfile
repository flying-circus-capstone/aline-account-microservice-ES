...
COPY --from=build /project/account-microservice/target/account-microservice-0.1.0.jar /app/account-microservice-0.1.0.jar
WORKDIR /app
RUN chown -R javauser:javauser /app
USER javauser

CMD "dumb-init" "java" "-jar" "account-microservice-0.1.0.jar"